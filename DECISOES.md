...
A única coisa que a IA fez e que não ficou muito bom foi colocar todo o CSS das classes do Bootstrap modificadas dentro das views. Mas eu resolvi isso facilmente apenas movendo o CSS para arquivos na pasta public.
